...
Client.prototype.addRemoteResource = function(options,callback){
   ...
   this.options.fullPath = [this.options.path, this.options.core, path]
                              ...
                              .join('/');
   this.queryRequest(this.options,callback);
   return self;
}
...
Client.prototype.createAddStream = function(options){
   var path = [this.options.path,(options || {}).core || this.options.core,'update/json?commit='+ this.autoCommit +'&wt=json']
      .filter(function(element){
         if(element) return true;
         return false;    
      })
...
Client.prototype.commit = function(options,callback){
   ...
   this.update(this.data,options,callback);
}
...
Client.prototype.update = function(data,options,callback){
   ...
   this.options.fullPath = [this.options.path,options.core || this.options.core,(options.update || 'update/json') + '?commit='+ (options.autoCommit || this.autoCommit) +'&wt=json']
                              .filter(function(element){
                                 if(element) return true;
                                 return false;    
                              })
                              .join('/');
   this.updateRequest(this.options,callback);
   return self;
}
...
Client.prototype.search = function(query,callback){
   ...
   this.options.fullPath = [this.options.path, query._core || this.options.core,'select?' + parameters + '&wt=json']
                              .filter(function(element){
                                 if(element) return true;
                                 return false;    
                              })
